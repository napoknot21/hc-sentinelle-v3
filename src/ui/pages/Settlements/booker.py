...
def amount_currency_section (
    ...
    key_amount = f"Settlement_Booker_1_amount" if key_amount is None else key_amount
    key_currency = f"Settlement_Booker_1_currency" if key_currency is None else key_currency

    amount, currency = amount_currency_fields(currencies, 1, key_amount, key_currency)
