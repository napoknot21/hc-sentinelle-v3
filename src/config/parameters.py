...
UBS_SETTLEMENTS_OTC_PAYMENT_FROM = os.getenv("UBS_SETTLEMENTS_OTC_PAYMENT_FROM")
UBS_SETTLEMENTS_OTC_PAYMENT_TO = os.getenv("UBS_SETTLEMENTS_OTC_PAYMENT_TO")
UBS_SETTLEMENTS_OTC_PAYMENT_CC = os.getenv("UBS_SETTLEMENTS_OTC_PAYMENT_CC")
UBS_SETTLEMENTS_OTC_PAYMENT_SUBJECT = os.getenv("UBS_SETTLEMENTS_OTC_PAYMENT_SUBJE")
UBS_SETTLEMENTS_OTC_PAYMENT_BODY = os.getenv("UBS_SETTLEMENTS_OTC_PAYMENT_BODY")

UBS_SETTLEMENTS_COLLATERAL_MGNT_FROM = os.getenv("UBS_SETTLEMENTS_COLLATERAL_MGNT_FROM")
UBS_SETTLEMENTS_COLLATERAL_MGNT_TO = os.getenv("UBS_SETTLEMENTS_COLLATERAL_MGNT_TO")
UBS_SETTLEMENTS_COLLATERAL_MGNT_CC = os.getenv("UBS_SETTLEMENTS_COLLATERAL_MGNT_CC")
UBS_SETTLEMENTS_COLLATERAL_MGNT_SUBJECT= os.getenv("UBS_SETTLEMENTS_COLLATERAL_MGNT_SUBJECT")
UBS_SETTLEMENTS_COLLATERAL_MGNT_BODY = os.getenv("UBS_SETTLEMENTS_COLLATERAL_MGNT_BODY")

UBS_SETTLEMENTS_FX_PAYMENTS_FROM = os.getenv("UBS_SETTLEMENTS_FX_PAYMENTS_FROM")
UBS_SETTLEMENTS_FX_PAYMENTS_TO = os.getenv("UBS_SETTLEMENTS_FX_PAYMENTS_TO")
UBS_SETTLEMENTS_FX_PAYMENTS_CC = os.getenv("UBS_SETTLEMENTS_FX_PAYMENTS_CC")
UBS_SETTLEMENTS_FX_PAYMENTS_SUBJECT = os.getenv("UBS_SETTLEMENTS_FX_PAYMENTS_SUBJECT")
UBS_SETTLEMENTS_FX_PAYMENTS_BODY = os.getenv("UBS_SETTLEMENTS_FX_PAYMENTS_BODY")

UBS_SETTLEMENTS_SECURITIES_FROM = os.getenv("UBS_SETTLEMENTS_SECURITIES_FROM")
UBS_SETTLEMENTS_SECURITIES_TO = os.getenv("UBS_SETTLEMENTS_SECURITIES_TO")
UBS_SETTLEMENTS_SECURITIES_CC = os.getenv("UBS_SETTLEMENTS_SECURITIES_CC")
UBS_SETTLEMENTS_SECURITIES_SUBJECT = os.getenv("UBS_SETTLEMENTS_SECURITIES_SUBJECT")
UBS_SETTLEMENTS_SECURITIES_BODY = os.getenv("UBS_SETTLEMENTS_SECURITIES_BODY")
...
TRADE_RECAP_EMAIL_DEFAULT_FROM = os.getenv("TRADE_RECAP_EMAIL_DEFAULT_FROM")
TRADE_RECAP_EMAIL_DEFAULT_TO = os.getenv("TRADE_RECAP_EMAIL_DEFAULT_TO")
TRADE_RECAP_EMAIL_DEFAULT_CC = os.getenv("TRADE_RECAP_EMAIL_DEFAULT_CC")
